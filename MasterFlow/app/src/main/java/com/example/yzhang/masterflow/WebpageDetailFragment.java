package com.example.yzhang.masterflow;
...
import com.example.yzhang.masterflow.dummy.DummyContent;
...
public class WebpageDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ...
            //in case any website asks to enable JavaScript (like http://www.hotmail.com)
